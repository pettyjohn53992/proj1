...
//        }
    ...
    public Table join (Table table2)
    {
        ...
        for(Comparable[] t1Row : this.tuples)
        {
        	for(Comparable[] t2Row : table2.tuples)
        	{
        		...
        		{
        			rows.add(joinMatchedRows(t1Row,t2Row));
        		}
        	}
        }
     ...
     */
    public Comparable[] joinMatchedRows(Comparable[] t1Row, Comparable[] t2Row)
    {
    	...
    	for(Comparable c : t2Row)
    	{
    		for(Comparable aList: list)
    		{
    			try{
		    			if(c.compareTo(aList) == 0)
		    			{
		    				exists = true;
		    				break;
		    			}
